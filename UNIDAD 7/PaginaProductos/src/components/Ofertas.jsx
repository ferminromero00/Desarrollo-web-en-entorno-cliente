...
export default function Carrusel() {
  ...
  useEffect(() => { Fetch('https://fakestoreapi.com/products/' + indice).then(data => setProducts(data)); }, [indice]);
  ...
  return (
    <>
      ...
      <p>Producto {indice} de 20</p>
      {indice < 20 && <button onClick={() => setIndice(indice + 1)}>{">"}</button>}
