...
function estudianteNotas() {
    ...
    if (numEstudiante >= 1 && numEstudiante <= notas.length) {
        // Obtenemos el estudiante seleccionado
        const estudiante = notas[numEstudiante - 1];
        ...
        if (trimestre === 1) {
            ...
            resultado = "La nota media es: " + Math.floor((estudiante.trim1 + estudiante.trim2 + estudiante.trim3) / 3);
        }
    } else {
