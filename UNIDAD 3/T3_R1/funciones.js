...
function lanzamiento6000() {
    ...
    document.getElementById("resultado").innerHTML =
        "Veces que salió el 1: " + cont1 + " veces<br>" +
        "Veces que salió el 2: " + cont2 + " veces<br>" +
        "Veces que salió el 3: " + cont3 + " veces<br>" +
        "Veces que salió el 4: " + cont4 + " veces<br>" +
        "Veces que salió el 5: " + cont5 + " veces<br>" +
        "Veces que salió el 6: " + cont6 + " veces<br>";
}
