const cadJsonBDCatetorias = `["electronics","jewelery","men's clothing","women's clothing"]`;

const cadJsonBDProductos = `
[
    {
      "id": 1,
...
const valida = () => {
  ...
  for (let i = 0; i < arrObjUsuarios.length; i++) {
    if (usuario === arrObjUsuarios[i].username && password === arrObjUsuarios[i].password) {
      ...
      document.getElementById("result").innerHTML = "Login incorrecto"
    }
  }
}
